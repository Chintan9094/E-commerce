    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {addresses.map(address => (
          <div key={address._id} className="bg-white p-6 border rounded-lg shadow">
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={editingAddress ? "Edit Address" : "Add Address"}>
      ...
      <Modal isOpen={isDeleteModalOpen} onClose={closeDeleteModal} title="Delete Address">
